...
<div class="terms-container">
    ...
    <ul>
        ...
        <li>
            <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or
                &quot;Our&quot; in this Agreement) refers to Shewings Foundation.</p>
        </li>
        <li>
        ...
        <li>
            <p><strong>Website</strong> refers to Shewings Foundation, accessible from <a
                    href="https://shewingsfoundation.com" rel="external nofollow noopener"
                    target="_blank">https://shewingsfoundation.com</a></p>
        </li>
        <li>
    ...
    <ul>
        ...
        <li>
            <p>By visiting this page on our website: <a href="https://shewingsfoundation.com"
                    rel="external nofollow noopener" target="_blank">https://shewingsfoundation.com</a></p>
        </li>
        <li>
            <p>By phone number: 8800633291</p>
        </li>
        <!-- <li>
    <p>By mail: info@shewings.com</p>
    </li> -->
    </ul>
</div>